...
// Auto-seed products, testimonials, and gallery on first startup
const BASE_URL = process.env.BACKEND_URL || `http://localhost:${PORT}`;
const productCount = db.prepare('SELECT COUNT(*) as count FROM products').get();
if (productCount.count === 0) {
  const seedProducts = [
    { name: "Valentine's Cupcakes", description: "Beautifully decorated cupcakes with fondant hearts, roses and love-themed toppers. Perfect for gifting.", price: 18.00, category: 'cupcakes', images: [`${BASE_URL}/uploads/valentines-cupcakes-1.jpg`, `${BASE_URL}/uploads/valentines-cupcakes-2.jpg`], sort_order: 1 },
    { name: "Oreo Caramel Brownies", description: "Fudgy chocolate brownies topped with Oreo cookies and a drizzle of smooth caramel sauce. Boxed in 4.", price: 12.00, category: 'brownies', images: [`${BASE_URL}/uploads/oreo-caramel-brownies-1.jpg`], sort_order: 2 },
    { name: "Oreo Brownie Box (6)", description: "Six indulgent Oreo-topped brownies with milk chocolate drizzle, presented in a windowed gift box.", price: 16.00, category: 'brownies', images: [`${BASE_URL}/uploads/oreo-brownie-box-1.jpg`], sort_order: 3 },
    { name: "Easter Cupcakes", description: "Spring-inspired cupcakes with pastel buttercream swirls and mini egg toppers. Available in boxes of 3.", price: 15.00, category: 'cupcakes', images: [`${BASE_URL}/uploads/easter-cupcakes-1.jpg`, `${BASE_URL}/uploads/easter-cupcakes-2.jpg`], sort_order: 4 },
    { name: "Easter Treat Box", description: "Mixed box with Easter cupcakes and chocolate bunny brownies — the perfect spring gift.", price: 22.00, category: 'boxes', images: [`${BASE_URL}/uploads/easter-treat-box-1.jpg`], sort_order: 5 },
    { name: "Mother's Day Cupcakes", description: "Box of 12 cupcakes with Best Mom Ever toppers and pastel buttercream. Ideal for Mother's Day.", price: 28.00, category: 'cupcakes', images: [`${BASE_URL}/uploads/mothers-day-cupcakes-1.jpg`, `${BASE_URL}/uploads/mothers-day-cupcakes-2.jpg`], sort_order: 6 },
    { name: "Oreo Brownie Slab", description: "Rich, fudgy brownie slab topped with whole Oreos and caramel — great for sharing.", price: 10.00, category: 'brownies', images: [`${BASE_URL}/uploads/oreo-brownie-slab-1.jpg`], sort_order: 7 },
    { name: "Caramel Oreo Brownie", description: "Single brownie with Oreo and caramel drizzle — the star of our brownie range.", price: 4.00, category: 'brownies', images: [`${BASE_URL}/uploads/caramel-oreo-brownie-1.jpg`, `${BASE_URL}/uploads/caramel-oreo-brownie-2.jpg`], sort_order: 8 },
    { name: "Easter Basket Hamper", description: "A wicker basket filled with Easter cupcakes, brownies, Creme Eggs and Kinder Chocolate.", price: 35.00, category: 'hampers', images: [`${BASE_URL}/uploads/easter-basket-1.jpg`, `${BASE_URL}/uploads/easter-basket-2.jpg`], sort_order: 9 },
    { name: "Caramel Brownie Slab", description: "Wide shot of our caramel Oreo brownie slab — great for sharing at events and parties.", price: 20.00, category: 'brownies', images: [`${BASE_URL}/uploads/caramel-brownie-slab-1.jpg`], sort_order: 10 }
  ];
