        ...
        <div className="about-grid" style={{
            ...
            <div style={{
              ...
              <img
                ...
                onError={e => {
                  ...
                  e.target.src = `${API_BASE}/uploads/brownie-classic.jpg`;
                }}
              />
            </div>
            {/* Floating badge */}
          ...
          <div>
            ...
            <h2 style={{
              ...
              Baked with love,<br />
              <span style={{ color: 'rgb(201,150,58)' }}>served with joy</span>
            </h2>
            ...
            <p style={{
              ...
              Demure Bakes is a home-based artisan bakery dedicated to crafting indulgent treats that bring people together. Every brownie, cupcake, and gift box is made fresh to order using premium ingredients.
            </p>
            ...
            <p style={{
              ...
              We believe that great bakes deserve great ingredients — no shortcuts, no compromise. Whether it's a birthday, a special occasion, or simply a treat for yourself, we pour our heart into every single order.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
              {[
                ...
                { value: '50+', label: 'Flavour Combos' },
                { value: '100%', label: 'Fresh to Order' },
              ].map(stat => (
                <div key={stat.label} style={{
                  ...
                  <div style={{ fontFamily: '"Baloo 2", cursive', fontWeight: 800, fontSize: '1.5rem', color: 'rgb(201,150,58)' }}>{stat.value}</div>
                  <div style={{ fontFamily: 'Nunito, sans-serif', fontSize: '0.78rem', color: 'rgb(107,79,58)', fontWeight: 600 }}>{stat.label}</div>
                </div>
              ))}
            </div>
