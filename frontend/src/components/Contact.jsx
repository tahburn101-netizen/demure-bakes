    ...
    <>
      ...
      <section id="contact" style={{
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 1.5rem', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.75rem', fontWeight: '600', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#c8a84b' }}>Get in Touch</span>
            <span style={{ color: '#c8a84b', fontSize: '0.75rem' }}>✦</span>
          </div>
          ...
          <p style={{
            ...
            Place your order online or reach out directly. We'd love to create something special for you.
          </p>

          {/* Buttons */}
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
            <a
              href="https://wa.me/447700000000?text=Hi%20Demure%20Bakes!%20I%27d%20like%20to%20place%20an%20order."
              target="_blank"
                ...
                <div style={{
                  ...
                  {bankDetails.bank_name && (
                    <div style={{ marginBottom: '0.5rem' }}>
                      ...
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem' }}>{bankDetails.bank_name}</span>
                    </div>
                  )}
                  {bankDetails.account_name && (
                    <div style={{ marginBottom: '0.5rem' }}>
                      <span style={{ color: '#c8a84b', fontSize: '0.75rem', fontWeight: '600', display: 'block' }}>Account Name</span>
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem' }}>{bankDetails.account_name}</span>
                    </div>
                  )}
                  {bankDetails.account_number && (
                    <div style={{ marginBottom: '0.5rem' }}>
                      <span style={{ color: '#c8a84b', fontSize: '0.75rem', fontWeight: '600', display: 'block' }}>Account Number</span>
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem' }}>{bankDetails.account_number}</span>
                    </div>
                  )}
                  {bankDetails.sort_code && (
                    <div>
                      <span style={{ color: '#c8a84b', fontSize: '0.75rem', fontWeight: '600', display: 'block' }}>Sort Code</span>
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem' }}>{bankDetails.sort_code}</span>
                    </div>
                  )}
                </div>
              )}
      ...
      <footer style={{
        ...
        <p style={{
          ...
          © {new Date().getFullYear()} Demure Bakes. All rights reserved. Made with ♥ and lots of butter.
        </p>
