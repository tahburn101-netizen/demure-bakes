...
const STEPS = ['Select Product', 'Your Details', 'Confirm & Pay'];
    ...
    >
      <div style={{
          ...
          {submitted ? (
            ...
            <div style={{ textAlign: 'center', padding: '1rem 0' }}>
              ...
              <p style={{
                ...
                Your order has been received. To confirm your order, please send a <strong>50% deposit</strong> via bank transfer using the details below.
              </p>
              ...
              {bankDetails && (bankDetails.account_number || bankDetails.bank_name) ? (
                <div style={{
                  ...
                  <div style={{
                    ...
                    Reference: <strong>DB-{orderId?.slice(0, 8).toUpperCase()}</strong>
                  </div>
                </div>
              ) : (
                <div style={{
              ...
              <p style={{
                ...
                Once your deposit is received, we'll confirm your order and get baking! 🎂
              </p>
            ...
            <div>
              <p style={{
                ...
                Choose what you'd like to order, or scroll down to request a custom item.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1rem' }}>
                {products.map(p => (
                  ...
                  >
                    ...
                    <div style={{ fontFamily: '"Baloo 2", cursive', fontWeight: 800, fontSize: '1.1rem', color: 'rgb(201, 150, 58)', flexShrink: 0 }}>£{p.price.toFixed(2)}</div>
                ...
                {/* Custom order option */}
                <div
                  onClick={() => setSelectedProduct({ id: 'custom', name: 'Custom Order', price: 0 })}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '1rem',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {selectedProduct && selectedProduct.id !== 'custom' && (
                <div style={{
                  ...
                  {selectedProduct.images?.[0] && (
                    <img src={selectedProduct.images[0]} alt={selectedProduct.name} style={{ width: '44px', height: '44px', borderRadius: '8px', objectFit: 'cover' }} />
                  )}
                  <div style={{ flex: 1 }}>
                    <div style={{ fontFamily: '"Baloo 2", cursive', fontWeight: 700, fontSize: '0.9rem', color: 'rgb(61, 35, 20)' }}>{selectedProduct.name}</div>
                    <div style={{ fontFamily: 'Nunito, sans-serif', fontSize: '0.8rem', color: 'rgb(107, 79, 58)' }}>£{selectedProduct.price.toFixed(2)} each</div>
                  </div>
              ...
              <div>
                ...
                <textarea
                  placeholder="Any special requests, dietary requirements, or personalisation..."
            ...
            <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  {[
                    ...
                    <div key={row.label} style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', padding: '0.3rem 0', borderBottom: '1px solid rgba(107,79,58,0.08)' }}>
                      <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '0.85rem', color: 'rgb(107, 79, 58)', flexShrink: 0 }}>{row.label}</span>
                  ...
                  {selectedProduct && selectedProduct.id !== 'custom' && (
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0 0 0' }}>
                      ...
                      <span style={{ fontFamily: '"Baloo 2", cursive', fontWeight: 800, fontSize: '1.1rem', color: 'rgb(201, 150, 58)' }}>£{(selectedProduct.price * form.quantity).toFixed(2)}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div style={{
                ...
                <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: '0.85rem', color: 'rgb(107, 79, 58)', margin: 0, lineHeight: 1.6 }}>
                  💳 A <strong>50% deposit</strong> is required to confirm your order. Bank transfer details will be shown after submission.
                </p>
              </div>
            </div>
          )}
        ...
        {!submitted && (
          <div style={{
            padding: '1rem 1.5rem',
            borderTop: '1px solid rgba(107, 79, 58, 0.1)',
            display: 'flex',
            gap: '0.75rem',
            flexShrink: 0,
            background: 'rgb(250, 247, 242)',
            ...
            {step < 2 ? (
              <button
                ...
                style={{
                  ...
                  fontWeight: 700,
                  fontSize: '0.95rem',
                  cursor: step === 0 && !selectedProduct ? 'not-allowed' : 'pointer',
                  transition: 'all 0.2s',
                }}
              >
                Continue →
